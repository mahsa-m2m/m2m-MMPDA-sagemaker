...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # --- Audio waveform ---
        wav_path = os.path.join(self.audio_root, f"{name}.wav")
...
if __name__ == "__main__":
    ...
    #     groundtruth_path="/data/DOLOS_train_GT.txt",
    #     frames_root="data/face_frames",
    #     mel_root="data/mel_spectrogram",
    #     affect_root="data/affect_features",
    #     openface_root="/data/openface_43",
    #     audio_root="data/audio_files"
    # )
    ...
    with open("data/DOLOS_test_no_label.pkl", "wb") as f:
