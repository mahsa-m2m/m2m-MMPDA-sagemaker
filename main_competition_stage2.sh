...
do
echo "****************************************************"
CUDA_VISIBLE_DEVICES=1 python train_test_feature.py \
    ...
    --test_list '../Deception_datasets/MMDD2025_features_unify/MMDD2025_final_test_features.pkl' \
